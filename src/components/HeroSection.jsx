...
const navigationLinks = [ { name: "Roadmap", href: "/roadmap" }, { name: "Tokenomics", href: "/tokenomics" }, { name: "Community", href: "/community" }, { name: "NFTs", href: "/nft" }, { name: "Contact", href: "/contact" }, { name: "Twitter", href: "https://x.com/MiraVersaToken" }, ];
...
{/* Navigation Links */}
  <nav className="absolute top-6 left-1/2 transform -translate-x-1/2 z-10 bg-black/50 backdrop-blur rounded-full px-6 py-2 flex gap-4 text-sm font-semibold text-yellow-300">
    {navigationLinks.map((link, i) => (
      <Link key={i} href={link.href} target={link.href.includes('http') ? '_blank' : undefined}>
