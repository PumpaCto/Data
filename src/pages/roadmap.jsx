...
return ( <> <Head> <title>Roadmap | MiraVerse</title> <meta
name="description"
content="Explore MiraVerse's vision from token launch to game universe domination."
/> </Head>

<div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white px-6 py-20">
    <h1 className="text-4xl md:text-6xl font-bold text-center text-primary mb-12 glow">
      Our Roadmap
    </h1>
